...
#define REQUEST_ENABLE_DISABLE_VOICE_CHAT 114 //add client to voice chats
...
#define RESPONSE_LOBBY_OWNER_CHANGED 218
...
#define RESPONSE_ERROR_LOBBY_IS_FULL 329
#define RESPONSE_START_GAME_NOT_ENOUGH_PLAYER_TO_START 330
