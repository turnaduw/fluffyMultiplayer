...
#define LOBBY_CELL_PLAYERS_STATUS_FONT_SIZE 12
#define LOBBY_CELL_INGAME_STATUS_FONT_SIZE 12
...
#define LOBBY_CELL_VOICE_STATUS_PADDING_X +0.0
#define LOBBY_CELL_VOICE_STATUS_PADDING_Y +50.0
#define LOBBY_CELL_TEXT_STATUS_PADDING_X +90.0
#define LOBBY_CELL_TEXT_STATUS_PADDING_Y +0.0
#define LOBBY_CELL_SPECTER_STATUS_PADDING_X +50.0
#define LOBBY_CELL_SPECTER_STATUS_PADDING_Y -2.0
#define LOBBY_CELL_LOCKED_STATUS_PADDING_X +0.0
#define LOBBY_CELL_LOCKED_STATUS_PADDING_Y +0.0
#define LOBBY_CELL_PLAYERS_STATUS_PADDING_X +90.0
#define LOBBY_CELL_PLAYERS_STATUS_PADDING_Y +50.0
#define LOBBY_CELL_INGAME_STATUS_PADDING_X +60.0
#define LOBBY_CELL_INGAME_STATUS_PADDING_Y +120.0
#define LOBBY_CELL_PRIVATE_STATUS_PADDING_X +55.0
#define LOBBY_CELL_PRIVATE_STATUS_PADDING_Y +55.0
#define LOBBY_CELL_GAMEMODE_STATUS_PADDING_X +50.0
#define LOBBY_CELL_GAMEMODE_STATUS_PADDING_Y +50.0
