...
namespace FluffyMultiplayer
{
  ...
  void FluffyDatabase::insertTestData()
  {
             ...
             std::string ipadd,  std::string portadd)
    {
      ...
      insertLobby(2, "1", "2", "lobby2", "2", "0", "1" , "0", "127.0.0.2", "8888");
      insertLobby(3, "2", "6", "lobby3", "3", "0", "0" , "1", "127.0.0.3", "8888");
      insertLobby(4, "1", "2", "lobby4", "4", "1", "1" , "0", "127.0.0.4", "8888");
      insertLobby(5, "0", "3", "lobby5", "5", "0", "0" , "0", "127.0.0.5", "8888");
      insertLobby(6, "0", "5", "lobby6", "6", "1", "1" , "1", "127.0.0.6", "8888");
      insertLobby(7, "0", "10", "lobby7", "7", "1", "0" , "1", "127.0.0.7", "8888");
      insertLobby(8, "1", "8", "lobby8", "8", "0", "1" , "0", "127.0.0.8", "8888");
      insertLobby(9, "2", "10", "lobby9", "9", "0", "0" , "1", "127.0.0.9", "8888");
      insertLobby(10, "2", "1", "lobby10", "10", "1", "0" , "0", "127.0.0.10", "8888");
