...
#define MS_ERROR_FAILED_TO_RELOGIN 506
...
#define MS_ERROR_FAILED_TO_RELOGIN_IDENTITY_INVALID_OR_NOT_EXISTS 419
#define MS_ERROR_FAILED_TO_RELOGIN_IDENTITY_EXPIRED 420
