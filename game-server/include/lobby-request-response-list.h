...
#define RESPONSE_YOU_ARE_JOINT_INTO_LOBBY
#define RESPONSE_PLAYER_KICKED_FROM_LOBBY //to all
#define RESPONSE_PLAYER_BANNED_FROM_LOBBY //to all
#define RESPONSE_GAME_STOPPED //to all
#define RESPONSE_GAME_STARTED //to all
#define RESPONSE_PLAYER_VOICE_CHAT_ENABLED // to all
#define RESPONSE_PLAYER_VOICE_CHAT_DISABLED // to all
#define RESPONSE_PLAYER_SENT_VOICE_MESSAGE // to all
#define RESPONSE_PLAYER_SENT_TEXT_MESSAGE  // to all
...
#define RESPONSE_UNKNOWN_REQUESST_GAME_PAUSED_OR_NOT_STARTED
#define RESPONSE_UNKNOWN_REQUEST_GAME_IS_NOT_STARTED
